...
def main(meshfile,nestdir,file,iexpt=10,iversn=22,yrflag=3) :
    
    nestdir=str(nestdir)[2:-2]
    logger.debug("nest directory is {}".format(nestdir))
    #
...
if __name__ == "__main__" :
	...
	parser.add_argument('nestdir',    type=str, nargs="+",  help="    ")
	...
	main(args.meshfile,args.nestdir,args.file,iexpt=args.iexpt,iversn=args.iversn,yrflag=args.yrflag)
